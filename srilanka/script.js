      ...
      cards: [
        {
          ...
          popular: false,
          perks: [
            'Hanoi 2 nights + Ha Long cruise 1 night',
            'Ha Long Bay overnight junk cruise',
            'All transfers & guided city tour',
            'Meals as per itinerary',
          ],
          btnLabel: 'Reserve 3N/4D Solo',
          pkgName: '3N/4D Quick Escape – Solo',
        },
        {
          label: '3N / 4D · Couple',
          oldPrice: '₹58,999',
          ...
          perks: [
            'Hanoi 2 nights + Ha Long cruise 1 night',
            'Romantic setup & couple activities',
            'Ha Long Bay overnight cruise',
            'All transfers & guided city tour',
            'Meals as per itinerary',
          ],
          btnLabel: 'Reserve 3N/4D Couple',
          pkgName: '3N/4D Quick Escape – Couple',
        },
        {
          label: '3N / 4D · Group (4+)',
          oldPrice: '₹1,19,999',
          ...
          perks: [
            'Hanoi 2 nights + Ha Long cruise 1 night',
            'Ha Long Bay overnight junk cruise',
            'All transfers & expert guided tours',
            'Group discounts on activities',
            'Meals as per itinerary',
          ],
          btnLabel: 'Reserve 3N/4D Group',
          pkgName: '3N/4D Quick Escape – Group',
        },
      ],
      perperson: {
        solo: '₹22,999+',
      ...
      cards: [
        {
          ...
          perks: [
            ...
            'Water puppet show & cultural tour',
            'All flights, transfers & guided tours',
          ],
          btnLabel: 'Reserve 4N/5D Solo',
          pkgName: '4N/5D Classic Journey – Solo',
        },
        {
          label: '4N / 5D · Couple',
          oldPrice: '₹99,999',
          ...
          perks: [
            'Hanoi · Ha Long Bay · Hoi An',
            'Luxury cruise + romantic Hoi An night',
            'Water puppet show & cultural experiences',
            'All flights, transfers & guided tours',
            '24/7 dedicated concierge',
          ],
          btnLabel: 'Reserve 4N/5D Couple',
          pkgName: '4N/5D Classic Journey – Couple',
        },
        {
          label: '4N / 5D · Group (4+)',
          oldPrice: '₹1,89,999',
          ...
          perks: [
            'Hanoi · Ha Long Bay · Hoi An',
            'Luxury overnight cruise for group',
            'Water puppet show & cultural tour',
            'All flights, transfers & guided tours',
            'Group activity discounts',
          ],
          btnLabel: 'Reserve 4N/5D Group',
          pkgName: '4N/5D Classic Journey – Group',
        },
      ],
      perperson: {
        solo: '₹36,999+',
      ...
      cards: [
        {
          ...
          popular: false,
          perks: [
            'Hanoi · Sapa · Ha Long · Hoi An · Da Nang',
            'Sapa highland village trekking',
            'Premium cruise + Vietnamese spa session',
            'All domestic flights, transfers & tours',
          ],
          btnLabel: 'Reserve 6N/7D Solo',
          pkgName: '6N/7D Grand Explorer – Solo',
        },
        {
          label: '6N / 7D · Couple',
          oldPrice: '₹1,69,999',
          ...
          perks: [
            'Hanoi · Sapa · Ha Long · Hoi An · Da Nang',
            'Sapa trekking + romantic Hoi An nights',
            'Premium cruise + couples spa session',
            'All domestic flights, transfers & tours',
            'VIP concierge & luxury suites',
          ],
          btnLabel: 'Reserve 6N/7D Couple',
          pkgName: '6N/7D Grand Explorer – Couple',
        },
        {
          label: '6N / 7D · Group (4+)',
          oldPrice: '₹3,19,999',
          ...
          perks: [
            'Hanoi · Sapa · Ha Long · Hoi An · Da Nang',
            'Sapa highland village trekking for group',
            'Premium cruise + group spa session',
            'All domestic flights, transfers & tours',
            'VIP concierge & family suites',
          ],
          btnLabel: 'Reserve 6N/7D Group',
          pkgName: '6N/7D Grand Explorer – Group',
        },
      ],
      perperson: {
        solo: '₹62,999+',
